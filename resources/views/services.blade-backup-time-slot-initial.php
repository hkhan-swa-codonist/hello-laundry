            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form id="vLaundryForm" action="">
                        ...
                        <!-------------------------------TAB Services------------------------------------->
                        <div class="services-form" v-show="step == 2">
                            <div class="step-title">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading"
                                                    data-service="serviceName">{{ $value->service_name }}</h4>
                        ...
                        <!-------------------------------TAB Collection----------------------------------->
                        <div class="collection-form" v-show="step == 3">
                            ...
                            <div id="deliveryForm" class="sub-form">
                                <div class="form-row">
                                    <div class="col-md-6 col-12">
                                        <div class="dropdown">
                        ...
                        @php
                            $user = Auth::user();
                        @endphp
                        <div class="personal-form" v-show="step == 4">
                            <div class="step-title">
                        ...
                        <div class="payment-form" v-show="step == 5">
                            <div class="step-title">
        ...
        $('#get_address_button').click(function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res['result'] == 'No Location Found') {
                        $("#laundryForm .filter-loader").removeClass("active");
                        $('#postCode').siblings('.res-msg').removeClass('serve').html('We do Not Serve in this Area');
                    }
                    else {
